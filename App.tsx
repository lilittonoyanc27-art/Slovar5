...
export default function App() {
  return (
    <div className="min-h-screen bg-brand-soft overflow-x-hidden selection:bg-brand-brown selection:text-white font-sans">
      ...
      <nav className="sticky top-0 z-50 bg-white/100 border-b border-slate-200/50 px-4 md:px-8 py-4 shadow-sm">
         <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-3 group">
               <div className="w-10 h-10 md:w-12 md:h-12 bg-brand-brown rounded-2xl flex items-center justify-center group-hover:rotate-6 transition-transform shadow-lg">
            ...
            <div className="flex items-center gap-2 md:gap-4">
               <div className="hidden sm:flex flex-col items-end mr-2">
                 <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none">Թեմա</span>
                 <span className="text-sm font-black text-brand-green uppercase leading-tight">Շինարարություն</span>
               </div>
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-8 py-12 relative min-h-[60vh]">
        <DictionaryView />
      </main>
      ...
      <footer className="py-12 mt-20 border-t border-slate-200/50 bg-white/50 backdrop-blur-sm">
         <div className="max-w-7xl mx-auto px-4 text-center">
            <p className="text-[10px] font-black uppercase tracking-[0.5em] flex items-center justify-center gap-2 text-slate-400">
               &copy; 2024 ԻՍՊԱՆԵՐԵՆԻ ԱԿԱԴԵՄԻԱ • Շինարարության Բառարան
            </p>
         </div>
      </footer>
    </div>
